...
//		private	var raFile		:RandomAccessFile;
		...
		public	function load(cartridge:Cartridge):void
		{
			this.cartridge = cartridge;
			var i:int, j:int;
			var ba:ByteArray = this.cartridge.rom;
		...
		private	function loadBatteryRam():void
		{
			if	(this.batteryRam)
			{
				try{
					...
					var encodedData:String = this.cartridge.ram;
					if (encodedData==null)
						return;
		...
		public	function closeRom():void
		{
			if (this.batteryRam && (!this.saveRamUpToDate))
			{
				try{
					...
					this.cartridge.ram = encodedData;
					
					this.saveRamUpToDate = true;
					trace("Battery RAM sent to user.");
